...
const Reviews = ({ gigId }) => {
  ...
  // Yeni yorum gönderen fonksiyon tanımla
  ...
  const handleSubmit = (e) => {
    ...
    // Dizideki seçlili olan inputu bulduk
  ...
  return (
    <div className="my-10">
      ...
      <div>
        <h2 className="font-semibold my-4">Add a Comment</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          ...
          <label className="mt-7">Write a Description</label>
          <input
